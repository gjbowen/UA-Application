...
public class ASCIIArtGenerator {
    ...
    public ASCIIArtGenerator(String artText, int textHeight, ASCIIArtFont fontType, String artSymbol){
        try {
            printTextArt( artText,  textHeight,  fontType,  artSymbol);
        } catch (Exception e) {
            System.out.println(artText);
        }
    }
    public ASCIIArtGenerator(String artText, int textHeight){
        try {
            printTextArt( artText,textHeight);
        } catch (Exception e) {
            System.out.println(artText);
        }
    }
